...
-- =============================================================================
-- Verificacion: deben aparecer los tres, con el usuario actual como DEFINER.
-- =============================================================================
SELECT ROUTINE_NAME, DEFINER, SECURITY_TYPE
  FROM information_schema.ROUTINES
 WHERE ROUTINE_SCHEMA = DATABASE()
   AND ROUTINE_NAME IN ('sp_reporte_anual_cuentas_por_cobrar',
                        'sp_reporte_cartera_estudiantes',
                        'sp_ia_contexto_personal')
 ORDER BY ROUTINE_NAME;

-- Prueba rapida (tenant 4, anio 2026). Debe devolver 8 conjuntos de resultados.
-- CALL sp_reporte_anual_cuentas_por_cobrar(2026, 4);
